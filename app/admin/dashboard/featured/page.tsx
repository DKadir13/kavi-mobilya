...
export default function FeaturedProductsPage() {
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      const formattedAll = allData.map((p: any) => ({
        ...p,
        id: p._id,
      }));
  ...
  }, [selectedProductId, selectedOrder, featuredProducts.length, loadData, submitting]);
                    ...
                    <tr key={productId} className="hover:bg-gray-50">
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              handleUpdateOrder(productId, parseInt(value))
                            }
                          >
                      ...
                      <td className="px-4 py-3 text-right">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => handleRemoveFeatured(productId)}
